...
export async function POST(req: Request) {
  ...
  try {
    ...
    await connection.execute('DROP TABLE IF EXISTS audiobooki, historia_zamowien, klient, komiksy, konta, koszyk, ksiazki, magazyn, platnosci, zamówienia');
    ...
    //   -- Your SQL insert statements for sample data
    // `);
    await connection.commit();
